    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-zinc-50 aria-selected:opacity-100"
        ),
        day_selected:
          "bg-zinc-800 text-zinc-50 hover:bg-zinc-800 hover:text-zinc-50 focus:bg-zinc-800 focus:text-zinc-50",
